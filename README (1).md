...
<p align="center">
  <a href="https://fortifywebx-scanner.onrender.com"><img alt="Live Demo" src="https://img.shields.io/badge/Live%20Demo-Try%20it%20now-4f7cff?style=for-the-badge"></a>
</p>
...
> **[🔗 Live Demo](https://fortifywebx-scanner.onrender.com)** — scans OWASP's official public Juice Shop demo instance. Free-tier hosting sleeps after 15 minutes idle, so the first load may take ~30–60 seconds to wake up.
...
**Try it live:** [fortifywebx-scanner.onrender.com](https://fortifywebx-scanner.onrender.com) — public demo, restricted to OWASP's official Juice Shop demo target for safety (see [Ethics](#ethics)).
...
### Web GUI (self-hosted, unrestricted)

```bash
python3 app.py
```

Then open `http://localhost:5000`, enter any authorized target, and view live results with downloadable reports.
